...
public class UserBean {
     ...
     */
    public void signup(String username, String password, String renamefirstname, String renamelastname,
        String renamephonenumber, String renameemail, String renameadress, String renamepostcode, String renamecity) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(username, password ,renamefirstname, renamelastname,
        renamephonenumber, renameemail, renameadress, renamepostcode,renamecity);
        user.addToGroup("renamepls-app-user");
        em.persist(user);
    }
